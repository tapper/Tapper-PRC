...
live:
	...
	ssh artemis@bancroft "cd /opt/artemis/opt-artemis64/; sudo rsync -ruv  ${SOURCE_DIR} ${DEST_DIR}; sudo tar -xzf ${PKG_DIR}/opt-artemis64.tar.gz"
	ssh artemis@bancroft "cd /opt/artemis/opt-artemis32/; sudo rsync -ruv  ${SOURCE_DIR} ${DEST_DIR}; sudo tar -xzf ${PKG_DIR}/opt-artemis32.tar.gz"
devel:
	./scripts/dist_upload_wotan.sh
